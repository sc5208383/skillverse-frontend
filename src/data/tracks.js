    ...
    parts: [
      {
        ...
        topics: [
          { key: 'unit1', label: 'Introduction', heading: 'Unit I — Introduction to Python Programming',
            ...
            steps: [
              { point: 'Introduction to Python - what the language is, in plain terms: a programming language designed to be easy to read and quick to write.',
                example: 'Example: print("Hi") is a complete, valid Python program - no class or main function needed.' },
              { point: 'History of Python - how and why the language was created.',
                example: 'Example: Guido van Rossum started building Python in December 1989 during a holiday break.' },
              { point: 'Versions of Python - the major releases and how they differ from one another.',
                example: 'Example: Python 2 allowed print "Hi" without brackets; Python 3 requires print("Hi").' },
              { point: 'Need and features of Python - why this language was designed the way it was, and what makes it different from languages like Java or C.',
                example: 'Example: Python uses indentation instead of curly braces { } to mark a block of code.' },
              { point: 'Applications of Python - the real-world fields (web development, data science, automation, AI) where Python is actually used today.',
                example: 'Example: many data-science tools like Pandas and NumPy are built and used with Python.' },
              { point: 'Installing Python on Linux and Windows - step-by-step, getting the Python interpreter set up on your own machine.',
                example: 'Example: on Windows you download an installer from python.org; on Ubuntu Linux, Python often comes pre-installed.' },
              { point: 'Installing a Python IDE - setting up an editor (like PyCharm, VS Code or Thonny) so you can comfortably write and run code.',
                example: 'Example: VS Code with the Python extension lets you run a script by pressing a single "Run" button.' }
            ],
            videos: [
          ...
          { key: 'unit3', label: 'Strings & Lists', heading: 'Unit III — Python Strings',
            body: 'This unit covers two of Python\'s most-used data structures: text (strings) and ordered collections (lists).',
            steps: [
              { point: 'Introduction to strings - string literals, and assigning a string to a variable, including multiline strings.',
